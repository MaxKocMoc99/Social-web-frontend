...
import NewPostPhoto from './photo/NewPostPhoto'
import axios from 'axios'
const NewPostMain = ({id, surname, name, photo}) => {
  ...
  return (
      ...
      <input value={text} onKeyPress={(e) => {
        if (e.key === 'Enter') {
          doPost(text)
        }
          }} onChange={e => setText(e.target.value)} className="main__newpost__input" placeholder="Что у вас нового?" />
