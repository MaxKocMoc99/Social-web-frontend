...
const PublicModal = ({ setPublicGroup, setCreateGroup }) => {
  ...
  return (
    ...
    <div className='communitites__header__create-theme__main'>
        <p className='communitites__header__create-theme__main__title'>Публичная страница</p>
        <p className='communitites__header__create-theme__main__text'>Расскажите всему миру о своём творчестве, <br/>
поделитесь успехами и новостями</p>
